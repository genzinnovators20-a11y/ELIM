...
/*
 * Official ELIMCOIN artwork, as supplied — vector, and the source of truth for
 * both marks. Every coin surface on the site resolves through these two
 * entries, so each mark stays identical everywhere it appears, and the `frame`
 * boxes are measured off each file's own alpha channel — which is what holds
 * the disc centred and at the weight the vector stand-in held.
 *
